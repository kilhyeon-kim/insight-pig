...
| SP_INS_WEEK_MANAGE_SOW | 관리대상 모돈 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_MODON | 모돈 현황 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_GB | 교배 실적 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_BM | 분만 실적 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_EU | 이유 실적 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_SG | 임신사고 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_DOPE | 도태폐사 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_CH | 출하 실적 추출 | TS_INS_WEEK, TS_INS_WEEK_SUB |
| SP_INS_WEEK_SCHEDULE | 작업예정 추출 | TS_INS_WEEK_SUB |
...
농장별 관리대상 모돈(미교배, 분만지연, 이유지연 등)을 추출하여 TS_INS_WEEK, TS_INS_WEEK_SUB 테이블에 저장합니다.
...
| **출력** | TS_INS_WEEK (요약), TS_INS_WEEK_SUB (GUBUN='ALERT') |
...
| **출력** | TS_INS_MASTER, TS_INS_WEEK 등 전체 테이블 |
...
BEGIN
    ...
    -- ================================================
    -- 2. 대상 농장 조회 및 TS_INS_WEEK 초기 생성
    -- ================================================
    FOR farm_rec IN (
    ...
    -- ================================================
    FOR farm_rec IN (
        SELECT FARM_NO FROM TS_INS_WEEK
