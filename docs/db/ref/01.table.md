...
인덱스:
  - IDX_TB_MODON (FARM_NO, PIG_NO) - PK
  - IDX_TB_MODON_01 (FARM_NO, FARM_PIG_NO, OUT_DT DESC, USE_YN)
  - IDX_TB_MODON_02 (FARM_NO, HYULTONG_NO, OUT_DT DESC, USE_YN)
  - IDX_TB_MODON_03 (FARM_NO, PIG_NO, OUT_DT DESC, USE_YN)
  - IDX_TB_MODON_04 (FARM_NO, IN_DT DESC, OUT_DT DESC, USE_YN)
...
인덱스:
  - IDX_TB_MODON_WK (FARM_NO, PIG_NO, WK_DT, WK_GUBUN) - PK
  - IDX_TB_MODON_WK_01 (FARM_NO, PIG_NO, WK_DT, WK_GUBUN, SEQ, USE_YN)
  - IDX_TB_MODON_WK_02 (FARM_NO, PIG_NO, USE_YN, SEQ)
  - IDX_TB_MODON_WK_03 (FARM_NO, PIG_NO, WK_DATE, WK_GUBUN) ★자주사용
```
...
- TRG_TB_MODON_WK_INSERT_01: INSERT 후 TA_FARM_STATS_INFO 갱신
...
```
PK: FARM_NO, PIG_NO, WK_DT, WK_GUBUN
FK: FARM_NO, PIG_NO, WK_DT, WK_GUBUN → TB_MODON_WK
```
