...
BEGIN
    ...
    INSERT INTO TS_INS_WEEK_SUB (MASTER_SEQ, FARM_NO, GUBUN, SUB_GUBUN, SORT_NO, CNT_1, CNT_2, CNT_3, VAL_1, VAL_2, VAL_3, VAL_4, VAL_5)
    VALUES (P_MASTER_SEQ, P_FARM_NO, 'SHIP', 'STAT', 1, V_WEEK_CNT, V_YEAR_CNT, V_GRADE1_CNT, V_GRADE1_RATE, V_WEEK_AVG, V_AVG_BACKFAT, V_FARM_PRICE, P_NATIONAL_PRICE);
