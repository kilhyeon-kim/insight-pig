...
BEGIN
    ...
    -- 관리대상 모돈
    SP_INS_WEEK_MANAGE_SOW(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);

    -- TODO: 추가 프로시저 호출
    -- SP_INS_WEEK_MODON(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
    -- SP_INS_WEEK_GB(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
    -- SP_INS_WEEK_BM(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
    -- SP_INS_WEEK_EU(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
    -- SP_INS_WEEK_SG(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
    -- SP_INS_WEEK_DOPE(P_MASTER_SEQ, P_JOB_NM, P_FARM_NO, V_LOCALE, P_DT_FROM, P_DT_TO);
